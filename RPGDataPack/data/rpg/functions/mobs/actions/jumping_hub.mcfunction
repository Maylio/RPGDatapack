#飛び掛かり
    #ダメージ
        ...
        execute as @s at @s if entity @a[distance=0..1.8] run tag @s add attacker
        execute as @s at @s as @a[distance=0..1.8] run tag @s add defender
        execute as @s at @s as @a[distance=0..1.8] run function rpg:conbat/conbat_calculation
